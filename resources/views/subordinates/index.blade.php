        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-semibold text-gray-800">Bawahan Saya</h2>
                </div>

                <p class="mb-4 text-gray-600">Departemen: <strong>{{ auth()->user()->department ?: '–' }}</strong></p>

                @if($subordinates->isEmpty())
                    <div class="bg-blue-50 text-blue-700 px-4 py-3 rounded-md">
                        Tidak ada bawahan di departemen ini.
                    </div>
                @else
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $sub->jabatan }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('bawahan.show', $sub) }}" 
